...
## Purpose
Build and deploy the VitePress site to GitHub Pages via a Node-only GitHub Actions workflow on push to main, reachable at the documented Pages project URL.
