# index-page-content Specification

## Purpose
Defines the content contract for the generated `index.md` homepage so it serves the
published VitePress site's two web audiences — human visitors and fetch-LLMs ingesting
pages over HTTP — rather than a local maintainer working from a checked-out repository.
